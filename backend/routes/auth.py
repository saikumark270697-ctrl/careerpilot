...
OTP_FROM_EMAIL = os.getenv("OTP_FROM_EMAIL", "Career Copilot <onboarding@resend.dev>")
...
def _display_name_from_email(email: str) -> str:
    ...
    return " ".join(part.capitalize() for part in local.split()) or "Career Copilot User"
...
def _send_otp_email(email: str, code: str):
    ...
    try:
        resend.Emails.send({
            "from": OTP_FROM_EMAIL,
            "to": [email],
            "subject": "Your Career Copilot login code",
            "html": f"""
                <div style="font-family:Arial,sans-serif;line-height:1.6;color:#111827">
                  <h2>Your Career Copilot login code</h2>
